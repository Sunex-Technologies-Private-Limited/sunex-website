...
export default function Healthcare() {
  ...
  return <>
    ...
    <section className="section content-wrap"><Reveal className="large-cta"><p className="eyebrow">SunEx Healthcare</p><h2>Start a care conversation<br /><em>with more clarity.</em></h2><p>Share the treatment context and support priorities that matter to you. Our guided enquiry will direct the conversation to the right next step.</p><Link href="/contact?interest=healthcare" className="action-pill">Discuss your pathway <span><HeartPulse size={16} /></span></Link></Reveal></section>
  </>;
}
