...
describe("Home supplied visual sequence", () => {
  ...
  it("renders the supplied future-city story and advances to the education story", () => {
    ...
    expect(screen.getByText("Students planned to train")).toBeTruthy();
    expect(screen.getByText("5+")).toBeTruthy();
    expect(screen.getByText("Products under R & D")).toBeTruthy();
    ...
    expect(screen.getByAltText(/Technology-enabled learning studio representing people and partnerships/i).getAttribute("src")).toBe("/images/sunex-home-learning-studio.jpg");
    ...
    expect(screen.getByAltText(/Sunlit sustainable city/i).getAttribute("src")).toBe("/images/sunex-home-future-city.jpg");
    ...
    expect(document.querySelectorAll(".sunex-testimonial-showcase__controls button")).toHaveLength(11);
    ...
    expect(screen.getByText("Dr. Ranganath H B")).toBeTruthy();
    expect(screen.getByText("Owner")).toBeTruthy();
    expect(screen.getByText("HSR Digital Hub, Mysuru")).toBeTruthy();
    expect(screen.queryByText("Dr. Manjunath H M")).toBeNull();
    expect(screen.queryByText("Only genuine and approved testimonials are published.")).toBeNull();
    act(() => vi.advanceTimersByTime(4000));
    expect(screen.getByText("Dr. Manjunath H M")).toBeTruthy();
    expect(screen.getByText("BIET, Davanagere")).toBeTruthy();
